...
// const fetchTemperature = function (event) {
...
//   let inputVal = value
//
//   $.ajax(`https://api.openweathermap.org/data/2.5/weather?q=${inputVal}&appid=${apiKey}&units=imperial`).done(function(weatherInfo){
//     console.log(weatherInfo);
//     const temperature = weatherInfo;
//     $('#weatherinfo').attr('src', temperature);
//   });
// };
//
//
